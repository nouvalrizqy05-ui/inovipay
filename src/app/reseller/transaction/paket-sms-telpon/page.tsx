...
export default function PaketSmsTelponPage() {
  ...
  useEffect(() => {
    api.get('/reseller/products?category=PAKET_SMS_TELPON')
  ...
  if (loading) return <Loading text="Memuat produk paket nelfon..." />
    ...
    return (
      <TransactionReceipt
        ...
        details={[
          ...
          { label: 'Kategori', value: 'Paket SMS & Telpon' }
        ]}
  ...
  return (
    <div className="pb-24">
      <PageHeader title="Paket SMS & Telpon" />
      ...
      {opName && filteredProducts.length > 0 ? (
        <div className="px-4 space-y-3 mb-8">
          <h3 className="text-sm font-bold text-gray-900 mb-4 px-1">Pilih Paket</h3>
